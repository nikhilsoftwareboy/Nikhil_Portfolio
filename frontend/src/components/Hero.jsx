                ...
                <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left z-20 mt-10 md:mt-0">
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            <a href="#contact" className="flex items-center justify-center px-6 py-4 bg-gray-900 dark:bg-[#131822] text-white border border-transparent dark:border-gray-800 rounded-xl font-semibold hover:bg-gray-800 dark:hover:bg-[#1e242c] transition-colors shadow-lg">
                                Hire Me
                            </a>
